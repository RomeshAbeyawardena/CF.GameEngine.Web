...
public record BulkExpireAccessTokenCommand(IEnumerable<Guid> AccessTokenIds, bool Bypass = false) : IUnitRequest, IRoleRequirement
{
...
public class BulkExpireAccessTokenCommandHandler(IAccessTokenRepository accessTokenRepository) : IUnitRequestHandler<BulkExpireAccessTokenCommand>
{
    ...
    {
        var result = await accessTokenRepository.BulkExpireAsync(request.AccessTokenIds, cancellationToken);
