...
public record FindUsersQuery(Guid ClientId, string? Username, string? NameContains = null, bool? IsSystem = null, bool NoTracking = true) : IUnitRequestCollection<UserDto>, IUserFilter;
