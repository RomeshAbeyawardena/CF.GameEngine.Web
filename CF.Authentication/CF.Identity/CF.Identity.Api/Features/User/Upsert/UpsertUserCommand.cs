...
public record UpsertUserCommand(EditableUserDto User, bool Bypass = false) : RoleRequirementBase(() => RoleRegistrar.List<UserRoles>(RoleCategory.Write)), IUnitRequest<Guid>;