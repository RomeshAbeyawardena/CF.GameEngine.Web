...
public class Tests
{
    ...
    public void Test1()
    {
        var sut0 = new ExceptionHandler<TestUnitRequest, IUnitResult<Customer>, ValidationException>();
        ...
        var sut = new ExceptionHandler<TestCollectionRequest, IUnitResultCollection<Customer>, ValidationException>();
        ...
        var sut1 = new ExceptionHandler<TestPagedRequest, IUnitPagedResult<Customer>, ValidationException>();
