...
public static class SwaggerGenOptionsExtensions
{
    ...
    /// <summary>
    /// Adds server addresses to Swagger generation, ensure you register the <see cref="IHttpContextAccessor"/> in your DI container.
    /// <para>In order for to work, ensure your configuration has:
    /// <code>
    /// "OpenApi:Contact:Email":"<email>",
    /// "OpenApi:Contact:Name":"<name>",
    /// </code> </para>
    /// </summary>
    /// <param name="options"></param>
    /// <returns></returns>
    public static SwaggerGenOptions UseOpenApiContactDocumentFilter(this SwaggerGenOptions options)
    {
        options.DocumentFilter<OpenApiContactDocumentFilter>();
        return options;
    }
}
