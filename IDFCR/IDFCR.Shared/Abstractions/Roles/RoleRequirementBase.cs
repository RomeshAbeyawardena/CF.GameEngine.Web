...
public abstract class RoleRequirementBase(Func<IEnumerable<string>> action, RoleRequirementType roleRequirementType = RoleRequirementType.Some) : IRoleRequirement
{
