...
{
    /// <summary>
    /// Gets an instance of a NotSupportedException with a message indicating that mapping is not supported, if this intended to be the lowest level filter available to your application.
    /// </summary>
